...
public class OverrideIcon extends ExtendedIcon implements Comparable<OverrideIcon>, IClickHandler {
    ...
    private void readBasic(ConfigurationSection section) {
        ...
        this.setName(section.isSet("NAME") ? AsciiPlaceholders.placeholdersToSymbols(Fallback.colorizeName(section.getString("NAME"))) : this.getName());
        this.setLore(section.isSet("LORE") ? AsciiPlaceholders.placeholdersToSymbols(Fallback.colorizeLore(section.getStringList("LORE"))) : this.getLore());
